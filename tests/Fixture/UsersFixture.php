...
class UsersFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'institution' => ['type' => 'string', 'length' => 255, 'null' => false, 'default' => 'INASSA', 'collate' => 'utf8_general_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
        ...
        'role' => ['type' => 'string', 'length' => 50, 'null' => false, 'default' => 'user', 'collate' => 'utf8_general_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
        'status' => ['type' => 'boolean', 'length' => null, 'null' => false, 'default' => '1', 'comment' => '', 'precision' => null],
        'first_login' => ['type' => 'boolean', 'length' => null, 'null' => false, 'default' => '1', 'comment' => '', 'precision' => null],
    ...
    public $records = [
        [
            ...
            'status' => 1,
            'first_login' => 1,
            'created' => '2017-04-06 16:37:40',
            'modified' => '2017-04-06 16:37:40'
        ],
    ];
}

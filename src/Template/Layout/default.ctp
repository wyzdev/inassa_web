<?php
/**
 * @copyright     Copyright (c) (Inassa 2021))
 * @link          nassagroup.com
 */
        ...
        <ul class="nav navbar-nav" id="menu">
           ...
           <!--  <li>
            ...
            <?php if ($this->request->session()->read('Auth.User')['role'] == 'admin') { ?>
                ...
                <li><?= $this->Html->link('<i class="fa fa-check"></i>' . ' Test API', ['controller' => 'clients', 'action' => 'testapiclient'], ['class' => 'list-dropdown', 'escape' => false]); ?></li>
                <?php
                ...
                <?php
                if ($this->request->controller == 'MiddlewareLogs' and $this->request->action == 'index')
                    echo "<li class='active'>";
                    else
                        echo "<li>";
                    ?>
                    <?= $this->Html->link('<i class="fa fa-file-archive-o"></i>' . ' Logs middleware', ['controller' => 'MiddlewareLogs', 'action' => 'index'], ['class' => 'list-dropdown', 'escape' => false]); ?></li>
                <?php
                if ($this->request->action == 'manuel')
                    ...
                    echo "<li>";
                    ?>
                <a class="list-dropdown" href="<?= 'tmp' . DS . "Inassa_ManuelUtilisateur.pdf" ?>" download target="_blank"><i class="fa fa-book"></i> Manuel Utilisateur</a></li>
            <?php } ?>
            <li class="divider"></li>
            ...
            <li class="dropdown img-dropdown">
                ...
                <ul class="dropdown-menu">
                    <?php if ($this->request->session()->read('Auth.User')['role'] == 'admin') { ?>
                        ...
                        <li class="divider"></li>
                        <li>
                            <?= $this->Html->link('<i class="fa fa-check"></i>' . ' Test API', ['controller' => 'clients', 'action' => 'testapiclient'], ['escape' => false]); ?></li>
                        <li class="divider"></li>
                        <?php
                        if ($this->request->action == 'readlogs')
                            echo "<li class='active'>";
                        ...
                        if ($this->request->controller == 'MiddlewareLogs' and $this->request->action == 'index')
                            ...
                            echo "<li>";
                        ?>
                        <?= $this->Html->link('<i class="fa fa-file-archive-o"></i>' . ' Logs middleware', ['controller' => 'MiddlewareLogs', 'action' => 'index'], ['escape' => false]); ?></li>
                        <li class="divider"></li>
                        <?php
                        if ($this->request->action == 'manuel')
                            echo "<li class='active'>";
                            ...
                            echo "<li>";
                        ?>
                        <a href="<?= 'tmp' . DS . "Inassa_ManuelUtilisateur.pdf" ?>" download target="_blank"><i class="fa fa-book"></i> Manuel Utilisateur</a></li>
                        <li class="divider"></li>
                    <?php } ?>
...
<footer class="navbar navbar-default navbar-fixed-bottom" style="margin-bottom: 0;">
    <div class="container">
        <p class="navbar-text pull-left">Copyright © INASSA <?= date('Y') ?>
        </p>
    </div>
</footer>
